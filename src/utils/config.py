...
class StrategiesConfig:
    ...
    vwap_bounce: Optional[VWAPBounceStrategy] = None
    stochastic_rsi: Optional[StochasticRSIStrategy] = None
    adx_trend: Optional[ADXTrendStrategy] = None
    bollinger_squeeze: Optional[BollingerSqueezeStrategy] = None
    pivot_point: Optional[PivotPointStrategy] = None
    ichimoku_cloud: Optional[IchimokuCloudStrategy] = None
    macd_divergence: Optional[MACDDivergenceStrategy] = None
    parabolic_sar_trend: Optional[ParabolicSARTrendStrategy] = None
    volume_breakout: Optional[VolumeBreakoutStrategy] = None
    multi_timeframe_momentum: Optional[MultiTimeframeMomentumStrategy] = None
