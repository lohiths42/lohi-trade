...
GERMANY_PROFILE = MarketProfile(
    ...
    news_sources=[
        NewsSource(name="Handelsblatt", url="https://www.handelsblatt.com/rss/", language="de", category="general"),
        NewsSource(name="Börse Frankfurt News", url="https://www.boerse-frankfurt.de", language="de", category="regulatory"),
        NewsSource(name="Reuters Germany", url="https://www.reutersagency.com/feed/", category="general"),
    ],
    data_suffix=".DE",
    ...
    default_symbols=[
        ...
        "DHL.DE", "VOW3.DE", "HEN3.DE", "BEI.DE", "RWE.DE",
    ],
