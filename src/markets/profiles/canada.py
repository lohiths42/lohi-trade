...
CANADA_PROFILE = MarketProfile(
    ...
    news_sources=[
        NewsSource(name="Globe and Mail", url="https://www.theglobeandmail.com/investing/rss/", category="general"),
    ...
    default_symbols=[
        ...
        "BN.TO", "CP.TO", "SHOP.TO", "BCE.TO", "TRI.TO",
        "SU.TO", "ATD.TO", "CSU.TO", "MFC.TO", "NTR.TO",
    ],
